...
public class All implements Initializable {
    ...
    public void loadUserData(){
        ...
        if (current != null){
            ...
            String query = "SELECT Date,AccountNumber,Revenue FROM Revenue where AccountSending='"+acc+"'";
            ...
            String query2 = "SELECT Date,AccountNumber,Expense FROM Expense where AccountSending='"+acc+"'";
